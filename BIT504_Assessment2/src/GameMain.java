...
public class GameMain extends JPanel implements MouseListener {
	...
	// TODO: create the enumeration for the variable below
	// ===========================================================
	...
	public GameMain() {
		...
		// Setup the status bar (JLable) to display status message
	...
	public void updateGame(Player thePlayer, int row, int col) {
		...
		if (board.hasWon(thePlayer, row, col)) {
			// TODO: check which player has won and update the current state to the
			...
			// TODO: set the current state to the draw game state
